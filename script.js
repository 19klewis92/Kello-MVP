...
const TRANSLATIONS = {
  ...
  en: {
    ...
    steps: [
      ...
      { id: 'q2', type: 'multiple', maxSelect: 3, label: 'Step 2', title: 'Which service do you want to try in Korea?', options: ['Hair', 'Makeup', 'Nails', 'Skincare', 'Waxing', 'Lashes', 'Tattoo', 'Scalp Care', 'Scrub', 'Etc'], hasEtc: true, grid: true },
      { id: 'q3', type: 'multiple', maxSelect: 3, label: 'Step 3', title: 'Pain points when booking a shop?', options: ['Language barrier', 'Korea Phone verification', 'Price reliability', 'Lack of info', 'Time slot difficulty', 'Etc'], hasEtc: true },
  ...
  ja: {
    ...
    steps: [
      ...
      { id: 'q2', type: 'multiple', maxSelect: 3, label: 'Step 2', title: '韓国で体験したいサービスは？', options: ['ヘア', 'メイクアップ', 'ネイル', '皮膚管理(エステ)', 'ワックス', 'まつげ', 'タトゥー', '頭皮ケア', 'アカスリ', 'その他'], hasEtc: true, grid: true },
      { id: 'q3', type: 'multiple', maxSelect: 3, label: 'Step 3', title: '美容室等の予約時に不便な点は？', options: ['言葉の壁', '韓国の電話番号認証', '不透明な価格設定', '情報の不足', '希望時間の予約が困難', 'その他'], hasEtc: true },
      { id: 'q4', type: 'multiple', maxSelect: 3, label: 'Step 4', title: 'どのような機能が必要ですか？', options: ['翻訳機能', '予約代行サービス', '信頼できる店舗/価格情報', 'ナビゲーション機能', '公共交通機関の案内', 'タクシー配車', 'コミュニティ等の情報共有', 'その他'], hasEtc: true },
    ]
  },
  zh: {
    ...
    steps: [
      ...
      { id: 'q3', type: 'multiple', maxSelect: 3, label: 'Step 3', title: '预约美容院时的难点？', options: ['沟通问题', '韩国手机验证', '价格缺乏透明度', '信息不足', '预约时段困难', '其他'], hasEtc: true },
      { id: 'q4', type: 'multiple', maxSelect: 3, label: 'Step 4', title: '您需要的功能？', options: ['翻译功能', '预约代办', '可靠的信息/价格', '导航功能', '公共交通信息', '打车服务', '社区分享', '其他'], hasEtc: true },
    ]
  },
  vi: {
    ...
    steps: [
      ...
      { id: 'q2', type: 'multiple', maxSelect: 3, label: 'Step 2', title: 'Bạn muốn thử dịch vụ nào tại Hàn Quốc?', options: ['Làm tóc', 'Trang điểm', 'Làm móng', 'Chăm sóc da', 'Tẩy lông', 'Lông mi', 'Hình xăm', 'Chăm sóc da đầu', 'Tẩy da chết toàn thân', 'Khác'], hasEtc: true, grid: true },
      { id: 'q3', type: 'multiple', maxSelect: 3, label: 'Step 3', title: 'Khó khăn khi đặt lịch làm đẹp?', options: ['Rào cản ngôn ngữ', 'Xác minh số điện thoại Hàn Quốc', 'Lo ngại về giá cả', 'Thiếu thông tin', 'Khó chọn thời gian', 'Khác'], hasEtc: true },
      { id: 'q4', type: 'multiple', maxSelect: 3, label: 'Step 4', title: 'Tính năng bạn cần?', options: ['Dịch thuật', 'Đại lý đặt lịch', 'Thông tin/giá cả uy tín', 'Điều hướng', 'Thông tin giao thông công cộng', 'Gọi taxi', 'Chia sẻ cộng đồng', 'Khác'], hasEtc: true },
    ]
  },
  th: {
    ...
    steps: [
      ...
      { id: 'q2', type: 'multiple', maxSelect: 3, label: 'Step 2', title: 'บริการเสริมความงามที่คุณอยากลองในเกาหลีคืออะไร?', options: ['ทำผม', 'แต่งหน้า', 'ทำเล็บ', 'ดูแลผิวพรรณ', 'แว็กซ์', 'ต่อขนตา', 'สัก', 'ดูแลหนังศีรษะ', 'สครับผิว (ขัดตัว)', 'อื่นๆ'], hasEtc: true, grid: true },
      { id: 'q3', type: 'multiple', maxSelect: 3, label: 'Step 3', title: 'ความลำบากเมื่อจองร้านเสริมสวย?', options: ['อุปสรรคทางภาษา', 'การยืนยันเบอร์โทรศัพท์เกาหลี', 'ความไม่ชัดเจนของราคา', 'ข้อมูลไม่เพียงพอ', 'จองเวลาที่ต้องการยาก', 'อื่นๆ'], hasEtc: true },
      { id: 'q4', type: 'multiple', maxSelect: 3, label: 'Step 4', title: 'ฟีเจอร์ที่คุณต้องการ?', options: ['ฟีเจอร์แปลภาษา', 'ตัวแทนรับจอง', 'ข้อมูล/ราคาที่เชื่อถือได้', 'ระบบนำทาง', 'ข้อมูลขนส่งสาธารณะ', 'เรียกแท็กซี่', 'แชร์ข้อมูลในคอมมูนิตี้', 'อื่นๆ'], hasEtc: true },
    ]
  },
  mn: {
    ...
    steps: [
      ...
      { id: 'q2', type: 'multiple', maxSelect: 3, label: 'Step 2', title: 'Солонгост ямар үйлчилгээг туршиж үзмээр байна вэ?', options: ['Үс засалт', 'Нүүр будалт', 'Хумс засал', 'Арьс арчилгаа', 'Вакс', 'Сормуус', 'Шивээс', 'Хуйхны арчилгаа', 'Биеийн скраб', 'Бусад'], hasEtc: true, grid: true },
      { id: 'q3', type: 'multiple', maxSelect: 3, label: 'Step 3', title: 'Салон захиалахад тулгардаг бэрхшээл?', options: ['Хэлний бэрхшээл', 'Солонгос утасны дугаар баталгаажуулах', 'Үнэ тодорхойгүй байх', 'Мэдээлэл дутмаг', 'Хүссэн цагтаа захиалах хэцүү', 'Бусад'], hasEtc: true },
      { id: 'q4', type: 'multiple', maxSelect: 3, label: 'Step 4', title: 'Танд ямар функц хэрэгтэй вэ?', options: ['Орчуулга', 'Захиалгын үйлчилгээ', 'Найдвартай мэдээлэл/Үнэ', 'Газрын зураг', 'Нийтийн тээврийн мэдээлэл', 'Такси дуудах', 'Олон нийтийн мэдээлэл хуваалцах', 'Бусад'], hasEtc: true },
    ]
  }
};
